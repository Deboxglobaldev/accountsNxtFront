...
$url = "" . $serverurlapi . "General/OfficeInfoListAPI.php";
logger($InfoMessage . " URL for API - " . $url);
        ...
        <div class="container-fluid">
          ...
          <div class="row gy-bvc" style="">
            ...
            <div class="col-md-2">
              <div class="search-input-grid">
                <h6>&nbsp;</h6>
                <div class="search-button"> <a href="addrloffice.php">
                    <button type="button" class="btn btn-default browsebutton pd-btns">Add New</button>
                  </a> </div>
              </div>
            </div>
          </div>
        ...
        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
          ...
          <tbody id="tablesearch">
            ...
            if (isset($branchData['status']) == 'true') {
              if (isset($branchData['OfficeList'])) {
                $no = 1;
                foreach ($branchData['OfficeList'] as $resultList) {
            ?>
                  <tr class="uyt hgte">
                    <td><?php echo $resultList['Name']; ?></td>
                    <td><?php if ($resultList['CenterType'] == '1') {
                          echo 'HO';
                        } elseif ($resultList['CenterType'] == '2') {
                          echo 'Regional Office';
                        }; ?></td>
                    <td><?php if ($resultList['Status'] == 1) {
                          echo 'Active';
                        } else {
                          echo 'In-Active';
                        } ?></td>
                    <td>
                      <div class="gvre">
                        <a href="addrloffice.php?editId=<?php echo encode($resultList['Id']); ?>" class="btn btn-default branchbtn">Edit</a>
                        <!-- <a href="product.php?type=<?php echo encode("product"); ?>" class="btn btn-default branchbtn ">Product</a> -->
                        <?php if ($resultList['Status'] == 1) { ?>
                        <a href="usercreation.php?CodeId=<?php echo encode($resultList['BranchCode']); ?>&type=<?php echo encode("housertype"); ?>" class="btn btn-default branchbtn ">Users</a>
                        <?php } ?>
                      </div>
                    </td>
                  </tr>
