...
if(isset($_POST['Search']))
{
  ...
  $url = $serverurlapi."General/productinfoList.php";
  logger($InfoMessage." URL for API - ".$url); 
  ...
  <div class="hk-pg-wrapper"  style="background-image: url(../html/dist/img/Religare-Dashboard-BG.JPG);">
    ...
    <form action="" method="post" />
      <div class="row gy-bvc" style="">
        <div class="col-md-3">
          <div class="search-input-grid">
            <h6 style="font-weight: initial;">Product&nbsp;Name</h6>
            <input class="inp-w" type="text" placeholder="Product Name" autocomplete="off" name="Name" value="<?php echo $_POST['Name']; ?>" id="Name">
          </div>
        </div>
        <div class="col-md-2">
          <div class="search-input-grid">
      ...
      <div class="row gy-bvc nn-mb">
        <div class="col-md-12">
          <div class="row lk-kl">
            <div class=""> <a href="addproductmaster.php">
    ...
    ?>
            <tr class="uyt hgte">
              ...
              <td><?php echo $resultList['ProductFullName']; ?></td>
              <td><?php if($resultList['Status']==1){echo 'Active';} else{ echo 'Inactive'; } ?></td>
              <td align="center"><div class="gvre"> <a href="addproductmaster.php?editId=<?php echo encode($resultList['Id']); ?>" class="btn btn-default branchbtn">Edit</a>
                </div></td>
            </tr>
            <?php
    $no++;}}}else{?>
