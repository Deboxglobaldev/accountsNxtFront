...
<title>Add Commission Rate</title>
  ...
  <div class="hk-pg-wrapper"  style="">
            ...
            <div class="row">
			  ...
			  <div class="col-md-3">
                <div class="input-grid">
                  ...
                  <select class="inp-t" name="commissionType">
					  <option value="">Select</option>
					  <option value="A" <?php if($regionData['commissionType']=='A'){?>selected="selected"<?php } ?>>Acceptance</option>
					  <option value="D" <?php if($regionData['commissionType']=='D'){?>selected="selected"<?php } ?>>Digitization</option>
					  <option value="I" <?php if($regionData['commissionType']=='I'){?>selected="selected"<?php } ?>>Incentive</option>
					</select>
                </div>
              </div>
              <div class="col-md-3">
                <div class="input-grid">
                  <h5>Form&nbsp;Type</h5>
                  <select class="inp-t" name="formType">
                    <option value="">Select</option>
                    <option value="49A" <?php if($regionData['formType']=='49A'){?>selected="selected"<?php } ?>>49A</option>
                    <option value="49AA" <?php if($regionData['formType']=='49AA'){?>selected="selected"<?php } ?>>49AA</option>
                    <option value="49B" <?php if($regionData['formType']=='49B'){?>selected="selected"<?php } ?>>49B</option>
                    <option value="CR PAN" <?php if($regionData['formType']=='CR PAN'){?>selected="selected"<?php } ?>>CR PAN</option>
                    <option value="CR TAN" <?php if($regionData['formType']=='CR TAN'){?>selected="selected"<?php } ?>>CR TAN</option>
                  </select>
                </div>
              </div>
              <div class="col-md-3">
    ...
    <section>
      <div class="nxrt full-bd" style="width: fit-content;">
        ...
        <input type="button" onClick="window.location.href='commissionRateMaster.php'" class="next" value="Exit">
      </div>
    </section>
  </div>
  </form>
