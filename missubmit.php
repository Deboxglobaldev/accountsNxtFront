                    ...
                    <section class="hk-sec-wrapper contas1">
                        <div class="dostas">
                            <div style="display: flex;">
                                ...
                                <h3>Mis Upload <?php if($_GET['t'] == 1){ echo 'PAN/TAN'; }elseif($_GET['t'] == 2){ echo 'eTDS'; }elseif($_GET['t'] == 3){ echo '24G'; } ?></h3>
                        ...
                        <div class="bs-example" style="padding-top: 14px">
                            ...
                            <div class="alert alert-dismissible fade show"
                                style="border: solid 2px;border-block-color: green;">
                        ...
                        <form class="form-inline" action="" method="post" enctype="multipart/form-data">
                            <div class="container-fluid dostas3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <h4>
                                            <button type="button" class="btn btn-default uploadbutton"
                                                id="misfileupload">upload</button>
                                        </h4>
                                    </div>
                                    <div class="col-lg-2">
                                        <h4>
                                            <a href="mislogfile.php" target="_blank"><button type="button"
                                                    class="btn btn-default"
                                                    style="background-color: darkorange;color:#FFFFFF">View
                                                    Log</button></a>
                                        </h4>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $("#misfileupload").click(function() {
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    url: 'misuploadfile.php?userId=<?php echo $_SESSION['UID']; ?>',
                    type: 'post',
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        if (list != 0) {
                            //console.log(list);
                            document.getElementById("status").innerHTML = list.Status;
                            document.getElementById("TotalRecordProcessed").innerHTML = list
