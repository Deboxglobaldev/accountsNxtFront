...
const b64Data = '<?php echo base64_encode(file_get_contents($imagePath)); ?>';
...
*/
          ...
          $backLocation = 'filesubmit.php?aid='.$AcknowledgementNumber.'&formType='.$_GET['formType'].'';
            ...
            <?php }else{
                ...
                ?>
            <iframe src="documentsform.php?aid=<?php echo $AcknowledgementNumber; ?>" width="100%" height="2200px" style=" border: 1px solid #ccc; display: block;" id="form1"></iframe>
            <?php     }elseif($page==3){ 
