            ...
            <table id="datatable" class="table" style="width:100%">
                ...
                <thead>
                    ...
                    <tr class="hgt">
                        ...
                        <th colspan="3">Ledger Name <a href="addAccountGroup.php" class="btn-button">Add</a>
                        </th>
...
?>
                    ...
                    <tr class="uyt hgte">
                        ...
                        <td><i onclick="showgroup(<?php echo $resultList->Id; ?>);"
                                class="fa fa-plus sgroup<?php echo $resultList->Id; ?>"></i>

                            <i style="display: none;" onclick="hidegroup(<?php echo $resultList->Id; ?>);"
                                class="fa fa-minus hgroup<?php echo $resultList->Id; ?>"></i>

                            <a href="addAccountSubGroup.php"><?php echo $resultList->Name; ?></a>
                        </td>
...
?>
                    ...
                    <tr style="background: aliceblue;display: none;"
                        class="subgroup<?php echo $resultList->Id; ?>">

                        <td style="padding-left: 65px!important;"><i
                                onclick="showaccount('<?php echo $resultLists->Id; ?>');"
                                class="fa fa-plus"></i>
...
?>
                    ...
                    <tr style="background: beige;display: none;"
                        class="account<?php echo $resultLists->Id; ?> mgroup<?php echo $resultList->Id ?>">
