...
if ($_POST['action'] == "exportaction") {
    ...
    if (trim($_POST['reportType']) == "excel") {
        ...
        $delimiter = ",";
        $filename = $_POST['ProductType'] . "_Ackwise_Status_Report_" . $_POST['fromDate'] . "_" . $_POST['toDate'] . ".csv";
        ...
        <form action="" method="POST"  id="exportfrm">
          <div class="row gy-bvc">
            <div class="col-md-2">
              ...
              <?php if($_SESSION["Type"] == 'BRANCH'){ ?>
                <input type="text" name="branchCode" class="form-control" value="<?php echo $_SESSION["BID"]; ?>" readonly="readonly" />
              <?php }else{ ?>
                <select class="form-control" name="branchCode" id="branchCode">
                    ...
                    //logger('RESPONCE RETURN FRO BRANCH MASTER: '.$resultBranchData);
            ...
            <div class="col-md-2">
              ...
              <input type="date" name="fromDate" class="form-control" value="<?php echo $_POST["fromDate"]; ?>" required />
            </div>
            <div class="col-md-2">
              <h6 style="font-weight: initial;">To Date</h6>
              <input type="date" name="toDate" class="form-control" value="<?php echo $_POST["toDate"]; ?>" required />
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
              ...
              <select class="form-control" name="dateType">
                <option value="1" <?php if ($_POST['dateType'] == "1") {
                                                        echo 'selected';
                                                    } ?>>Ack. Date </option>
                <option value="2" <?php if ($_POST['dateType'] == "2") {
                                                        echo 'selected';
                                                    } ?>>Rejection Date </option>
                <option value="3" <?php if ($_POST['dateType'] == "3") {
                                                        echo 'selected';
                                                    } ?>>NSDL Confirmation Date </option>
              </select>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
              <div>
                ...
                <input type="submit" name="Search" class="btn btn-success" onClick="searchFunc('searchaction');" value="Search" />
                <input type="submit" name="Search" class="btn btn-success" id="expbtn" disabled onClick="searchFunc('exportaction');" value="Export Data" />
              </div>
            </div>
          </div>
        </form>
