...
<title>Acknowledegment Receiving</title>
...
<div class="hk-wrapper hk-vertical-nav">
  ...
  <div class="hk-pg-wrapper">
	...
	<form method="post" action="">
	  ...
	  <div class="col-md-4">
          <div class="flx">
            <input type="number" name="range" id="range" value="" placeholder="Enter Range.." class="form-control" onBlur="CheckValidate(this.value);" required >
		...
		<div class="col-md-4">
          <div class="flx">
			...
			<p><?php echo  $returndata->Message; ?><br><?php if($returndata->FromRange!=''){ echo 'Receiving Range is: '.$returndata->FromRange.'-'.$returndata->ToRange; } ?>  </p>
          </div>
        </div>
      ...
      <div class="row gy-bvc" style="margin-top:25px;">
        <div class="col-md-6">
          <div class="flx">
			...
			<input type="hidden" name="temprange" id="temprange" value="<?php echo '5'; //echo $returndata->ToRange-$returndata->FromRange; ?>">
          </div>
        </div>
        <div class="col-md-4">
          <div class="flx">
		...
		<div class="col-md-2">
          <div class="flx">
          <a href="ackreceiving.php" class="btn btn-success">Save</a>
          </div>
        </div>
      </div>
    </div>
