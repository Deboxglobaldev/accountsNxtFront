...
if($_POST['action']=='createbunch'){
	...
	logger("Response return from BUNCH API: ". $response); 
...
$saveTo = "vendors/barcode/barcode.php?codetype=Code39&size=40&text=".$dashData->BunchNo."&print=true";
...
if(!isset($_SESSION['branchId']))
{
  ...
  exit();
	...
	$jsonPost = '{ "UserType": "'.$_SESSION["Type"].'", "UserId": "", "UserTypeId": "'.$_SESSION["branchId"].'","page":"documentmanagementpage"}';
                        ...
                        <table class="table table-bordered " id="tableID" style="width:100% !important;">
                            <thead>
                                <tr class="headline" style="background: #757575;">
                                    <th class="thCls" style="   color: #fff;"><input
                                            name="ackknowledmentCheckAll" type="checkbox" class=""
                                            id="ackknowledmentCheckAll"
                                            style="height: 17px;width: 50px;margin-top: 0;text-align: center;" /></th>
                                    <th class="thCls" style="    color: #fff;">Acknowledge
                                        No.</th>
                                    <th class="thCls" style="  color: #fff;">
                                        Prod.&nbsp;Type</th>
                                    <th class="thCls" style="   color: #fff;">Stage</th>
                                    <th class="thCls" style=" color: #fff;">Sub Stage
                                    </th>
                                    <th class="thCls" style="  color: #fff;">
                                        Bunch&nbsp;Number</th>
                                </tr>
...
?>
                                <tr>
                                    <td><input type="checkbox"
                                            ...
                                            value="<?php echo $list->Acknowledgement; ?>"
                                            name="acknowledgmentchecksingle[]" class="deleteack"
                                            onClick="checkProductType('<?php echo strtoupper($list->ProductType); ?>');" />
                                    </td>
                                    ...
                                    <td><a href="courierdetail.php?bunchNumber=<?php echo $list->BunchNumber; ?>"><?php if($list->BunchNumber!=''){ ?><?php echo $list->BunchNumber; ?><br><span
                                                style="font-size: 12px;text-align: center; font-weight: 700;">Add
                                                Courier
                                                Detail</span><?php } ?></a></td>
                                </tr>
                                <?php
$no++; }  
}else{
