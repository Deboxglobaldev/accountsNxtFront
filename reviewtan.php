...
$imagePath = $serverurlapi.'BulkUpload/uploads/tanpdf/'.$_GET['aid'].'.pdf';
...
if(isset($_POST['action'])=="reviewdatasubmit"){
  ...
  $AcknowledgementNumber = trim($acknowledmentnumber);
  $jsonPost = '{ "UserId": "", "UserName": "", "Stage": "'.$stage.'", "FormType": "'.strtoupper($Revised).'", "AcknowledgementNumber":"'.$_GET['aid'].'"}';
...
<div class="col-md-8">
<div class="form-group">
<input type="email" name="email1" id="email1" class="form-control" value="<?php if($email1!=''){ echo $email1; } ?>" style="width: 61%;" readonly>
</div>
</div>
</div>
<div class="row">
...
<div class="col-md-8">
<div class="form-group">
<input type="email" name="email2" id="email2" class="form-control" value="<?php if($email2!=''){ echo $email2; } ?>" style="width: 61%;" readonly>
</div>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<p class="para" for="first" style="margin-left: 20px;"><span class="numHead">3</span>&nbsp;Nationality of Deductor</p>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<div class="col-md-4">
<div class="form-group">
<p class="para" for="first" style="margin-left: 20px;"><span class="numHead">4</span>&nbsp;Permanent Account Number (PAN)</p>
</div>
</div>
<div class="col-md-8">
<div class="form-group">
...
<div class="col-md-4">
<div class="form-group">
<p class="para" for="first" style="margin-left: 20px;"><span class="numHead">5</span>&nbsp;Exiting Tax Deduction Account Number</p>
</div>
</div>
<div class="col-md-8">
<div class="form-group">
<input type="text" name="oldtandeduction" id="oldtandeduction" class="form-control inputborder yter" value="<?php if($oldtandeduction!=''){ echo $oldtandeduction; } ?>" style="width: 61%;" readonly>
</div>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<p class="para" for="first" style="margin-left: 20px;"><span class="numHead">6</span>&nbsp;Exiting Tax Collection Account Number</p>
</div>
</div>
<div class="col-md-8">
<div class="form-group">
<input type="text" name="oldtancollection" id="oldtancollection" class="form-control inputborder yter" value="<?php if($oldtancollection!=''){ echo $oldtancollection; } ?>" style="width: 61%;" readonly>
</div>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<p class="para" for="first" style="margin-left: 20px;"><span class="numHead">7</span>&nbsp;Ack. Date(DD-MM-YY)</p>
</div>
</div>
<div class="col-md-8">
<div class="form-group">
...
?>
<input type="text" name="acknwoledmentdate" id="acknwoledmentdate" onChange="getDate(this.value);"  class="form-control inputborder inputtyodr  datepicker isdobupdateflagCls" value="<?php echo dateFormat($acknwoledmentdate); ?>"  <?php if($acknwoledmentdate!=''){ ?>style="width: 61%;pointer-events: none;"<?php } ?> readonly>
</div>
</div>
</div>
</div>
...
<div class="col-md-8">
<div class="form-group">
<input type="text" name="applicationdate" id="DateAgreement" onChange="getDate(this.value);"  class="form-control isdobupdateflagCls" value="<?php echo dateFormat($applicationdate); ?>" style="width: 61%;" readonly>
</div>
</div>
</div>
</div>
...
<?php if($Revised=="49B"){ ?>
<a href="dataentrytan.php?aid=<?php echo $_GET['aid']; ?>&formType=<?php echo $Revised; ?>&page=2" class="previous"><i class="fa fa-angle-left" ></i> Back <i class="fa fa-angle-left" ></i> Page 1 </a>
<?php }else{ ?>
<a href="dataentrytan.php?aid=<?php echo $_GET['aid']; ?>&formType=<?php echo $Revised; ?>&page=2" class="previous"><i class="fa fa-angle-left" ></i> Back <i class="fa fa-angle-left" ></i> Page 1</a> 
<?php } ?>
<?php 
