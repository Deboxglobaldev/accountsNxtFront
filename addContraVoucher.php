...
$url = $serverurlapi."General/dcVoucherNoteAPI.php";
      ...
      <div class="container-fluid full-bd">
        <div class="row">
         <div class="col-md-1">
          ...
          <div class="col-md-1">
            <h6>Date<span class="mandat">*</span></h6>
          </div>
          <div class="col-md-2">
            <input type="text" name="voucherDate" id="voucherDate"  class="inp-t datepicker" required readonly="readonly" style="background:#f7f7f7;">
          </div>
          <div class="col-md-1">
            <h6>Narration</h6>
          </div>
          <div class="col-md-2">
            <input type="text" name="narration" id="narration"  class="inp-t">
          </div>
        </div>
      </div>
    </section>
            ...
            <?php for($w=1;$w<=1;$w++){?>
             <tr id="row_<?php echo $w; ?>">
				...
				foreach($accountData->AccountNameData as $resultList){
					?>
			   	<option value="<?php echo $resultList->AccountName; ?>"><?php echo $resultList->AccountName; ?></option>
			   	<?php } } }	?>
			   	</select>
			   </td>

			   <td><input type="text" name="code[]" id="code_<?php echo $w; ?>" class="debitsum inp-t newdate" value="" ></td>

			   	<td><input type="number" name="credit[]" id="credit_<?php echo $w; ?>" class="creditsum inp-t newdate" value="0" ></td>
				<td><input type="number" name="debit[]" id="debit_<?php echo $w; ?>" class="creditsum inp-t newdate" value="0" ></td>
			</tr>
              <?php } ?>
            <tr id="commonrow">
    ...
    <script> 
        ...
        $(document).ready(function () { 
            $(".add-row").click(function () { 
				...
				$no=1;
				foreach($accountData->AccountNameData as $resultList){
				?><option value='<?php echo $resultList->AccountName; ?>'><?php echo $resultList->AccountName; ?></option><?php } } } ?></select></td><td><input type='text' name='code[]' id='code_"+rowno+"' class='debitsum inp-t newdate'  value=''></td><td><input type='number' name='credit[]' id='credit_"+rowno+"' class='creditsum inp-t newdate' value='0' ></td><td><input type='number' name='debit[]' id='debit_"+rowno+"' class='creditsum inp-t newdate' value='0' ></td></tr>"; 
