...
$resultList = $getData['billPeriod'];
$getResult = $resultList[0];
curl_close($ch);
}
?>
<!DOCTYPE html>
...
<title>Add Bill Information</title>
    ...
    <section class="">
      <div class="container-fluid full-bd">
        <div class="row">
          <div class="col-md-3">
            <h5>From&nbsp;Date</h5>
            <input type="text" name="fromDate" id="fromDate"  class="inp-t newdate datepicker" value="<?php echo ($getResult['FromDate']!='') ? date('d-m-Y',strtotime($getResult['FromDate'])) : ""; ?>" readonly="readonly" required>
          </div>
          <div class="col-md-3">
            <h5>To&nbsp;Date</h5>
            <input type="text" name="toDate" id="toDate"  class="inp-t newdate datepicker" value="<?php echo ($getResult['ToDate']!='') ? date('d-m-Y',strtotime($getResult['ToDate'])) : ""; ?>" readonly="readonly" required>
          </div>
          <div class="col-md-3">
            <h5>Bill&nbsp;Date</h5>
            <input type="text" name="billDate" id="billDate"  class="inp-t newdate datepicker" value="<?php echo ($getResult['BillDate']!='') ? date('d-m-Y',strtotime($getResult['BillDate'])) : ""; ?>" readonly="readonly" required>
          </div>
          <div class="col-md-3">
            <h5>Due&nbsp;Date</h5>
            <input type="text" name="dueDate" id="dueDate"  class="inp-t newdate datepicker" value="<?php echo ($getResult['DueDate']!='') ? date('d-m-Y',strtotime($getResult['DueDate'])) : ""; ?>" readonly="readonly">
          </div>
        </div>
      </div>
    </section>
