...
<div class="row">
<div class="col-lg-6">
<input type="text" name="AcknowledgementNumber" class="form-control" id="AcknowledgementNumber" placeholder="Acknowledgement Number" required>
</div>
<div class="col-lg-2">
<h4>
<button type="button" class="btn btn-default uploadbutton" id="misfileupload">Submit</button>
</h4>
</div>
</div>
</div>
...
<th class="thCls" style=" font-size: 15px;  font-weight: 700; color: #fff;">Activity Log.</th>
</tr>
</thead>
...
$.ajax({
url: '../General/auditpanlog_api.php',
type: 'post',
data: formData,
contentType: false,
processData: false,
