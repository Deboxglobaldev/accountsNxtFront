...
function funcCheckOtherLastName(fieldVal,ErrorId){
	var ApplicationStatus = $('#ApplicationStatus').val();
	if(fieldVal!=''){
		if(ApplicationStatus=='P'){
			if(!fieldVal.match(/^[a-zA-Z\ \']{0,25}$/)){
...
function funcCheckOtherFirstName(fieldVal,ErrorId){
...
function funcCheckOtherMiddleName(fieldVal,ErrorId){
	...
	funcCheckOtherFirstName(FirstNameOther,'FirstNameOtherError');
}

function funcOtherName(){
	var ApplicationStatus = $('#ApplicationStatus').val();
	...
	if(KnownByOther=="Y"){
		funcCheckOtherLastName(LastNameOther,"LastNameOtherError");
		funcCheckOtherFirstName(FirstNameOther,"FirstNameOtherError");
		funcCheckOtherMiddleName(MiddleNameOther,"MiddleNameOtherError");
	}
}
...
function validateForm2(){
	...
	var ratitlecode = $('#ratitlecode').val();
	var ralastname = $('#ralastname').val().trim();
	...
	if(RegistrationNumberFirm!=''){
		if(RegistrationNumberFirm.length>30){
			$('#RegistrationNumberFirmError').show();
			$('#RegistrationNumberFirmError').text('Length should be 30 digit long');
			return false;
		}
		else{
	...
	if(orgname!=''){
		if(orgname.length>64){
			$('#orgnameError').show();
			$('#orgnameError').text('Length should be 64 character');
			return false;
		}
		else{
			$('#orgnameError').hide();	
	...
	if(ratitlecode!=''){
		funcCheckRepLastName(ralastname,'ralastnameError');
	}
