...
//=============================AGENT NUMBER==================
$('#agentnumbercheck').hide();
var agentnumber_err = true;
//for first name field
$('#AgentNumber').keyup(function(){
	agentnumber_check();
});

function agentnumber_check(){
   var agentnumber_val = $('#AgentNumber').val();
   if(agentnumber_val.length == ''){
	  $('#agentnumbercheck').show();
	  $('#agentnumbercheck').html("Please Fill The Agent Number *");
	  $('#agentnumbercheck').focus();
	  $('#agentnumbercheck').css("color","red");
	  agentnumber_err = false;
	  return false;
   }else{
	  $('#agentnumbercheck').hide();
   }
   if((agentnumber_val.length > 5)){
	  $('#agentnumbercheck').show();
	  $('#agentnumbercheck').html("agent number lenght must be 5 *");
	  $('#agentnumbercheck').focus();
	  $('#agentnumbercheck').css("color","red");
	  agentnumber_err = false;
	  return false;
    ...
    var agentnumberregex = /^[0-9]/;
	var anumberValid = agentnumberregex.test(agentnumber_val);
	
	if (!anumberValid) {
	$('#agentnumbercheck').show();
	$('#agentnumbercheck').html("only allow numbers");
	$('#agentnumbercheck').focus();
	$('#agentnumbercheck').css("color","red");
	agentnumber_err = false;
	return false;
...
$('#btnsubmit').click(function(){
		...
		if((user_err = true) && (addressone_err = true) && (city_err = true) && (pin_err = true) && (primaryemail_err = true) && (cperson_err = true) && (agentnumber_err = true) && (pannumber_err = true) && (tannumber_err = true) && (gstnumber_err = true) && (branchcode_err = true) && (financialcode_err = true) && (bankname_err = true) && (ifsccode_err = true) && (accountnumber_err = true) && (branchname_err = true)){
		return true;
		}else{
		return false;
		}
