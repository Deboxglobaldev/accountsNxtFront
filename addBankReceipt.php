...
$url = $serverurlapi."General/addBankReceiptAPI.php";
 ...
 <script> 
        ...
        $(document).ready(function () { 
            $(".add-row").click(function () { 
				...
				$no=1;
				foreach($accountData->AccountNameData as $resultList){
				?><option value='<?php echo $resultList->AccountName; ?>'><?php echo $resultList->AccountName; ?></option><?php } } } ?></select></td><td><input type='number' name='credit[]' onkeyup='funcCreditEnable("+rowno+");' onBlur='funcSumValue();' id='credit_"+rowno+"' class='creditsum inp-t newdate' value='0' ></td><td><input type='text' name='narration[]' id='narration_"+rowno+"' class='inp-t newdate'></td></tr>"; 
